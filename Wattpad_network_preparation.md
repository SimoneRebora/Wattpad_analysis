...
##Save all
write.csv(user_book_pair_stats_df, file = "edges.csv", row.names = F)
write.csv(nodes_table, file = "nodes.csv", row.names = F)
write.csv(anonymizing_table, file = "anonymizing_table.csv", row.names = F)
```
